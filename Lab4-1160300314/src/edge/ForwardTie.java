...
/**
 * Describe the interaction between two persons if the former had forwarded Weibo of the latter. And
...
public class ForwardTie extends DirectedEdge {
  ...
  public ForwardTie(String label, double weight) throws InputFileAgainException {
    ...
    if (weight <= 0 || weight > 1) {
      throw new IllegalEdgeParamsException("Weight of Forward Connection is illegal");
    }
  }
