...
public class Movie extends Vertex {
  ...
  Safety for Rep Exposure:
      All other kinds of fields except label(name) in movie are modified by key word private.
      Clients can access it by the getter function and there no other function can changer the
      fields except fillVertexInfo which is strictly limited.
   */
  ...
  /**
   * Fill other fields in movie with a string array of three strings, which are the releasing year,
   * nation and IMDB score in order.
   *
   * @param args String array
   */
  @Override
  public void fillVertexInfo(String[] args)
      throws IllegalParamsNumberException, IllegalVertexParamsException {
    if (args == null) {
  ...
  public String toString() {
    return "Movie{" + "name='" + getLabel() + '\'' + ", releaseYear=" + releaseYear
        + ", nation='" + nation + '\'' + ", score=" + score + '}';
  }
