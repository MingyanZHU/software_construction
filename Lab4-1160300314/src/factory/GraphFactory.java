...
public class GraphFactory {
        ...
        switch (list.get(0)) {
          ...
          case "Vertex":
            ...
            if (!vertexType.contains(list.get(2))) {
              ...
              throw new IllegalVertexTypeException(list.get(2) + " is an illegal vertex type in "
  ...
  private static Graph graphIni(String graphType, String graphName) throws InputFileAgainException {
    /**
    ...
    if(!matcher.find()) {
      throw new InputFileAgainException(graphName + " is illegal in [\\w]+");
    }
