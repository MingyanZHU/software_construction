...
public class NetworkTopologyTest {
    ...
    public void testNetworkTopology() {
        try {
            Vertex computer = VertexFactory.createVertex("Computer1", "Computer", new String[]{"192.168.1.101"});
            ...
            Edge r1s1 = EdgeFactory.createEdge("R1S1", "NetworkConnection", 100, Arrays.asList(router, server));
            Edge c1s1 = EdgeFactory.createEdge("C1S1", "NetworkConnection", 10, Arrays.asList(computer, server));
