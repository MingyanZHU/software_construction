...
public class SocialNetworkTest {
    ...
    private static final Tweet tweet1 = new Tweet(1, "alyssa", "is it reasonable to talk about rivest so much?@obama", d1);
    ...
    public void testMyTestCases(){
    	...
    	assertTrue(followsGraph.get(tweet1.getAuthor()).contains("obama"));
    }
}
