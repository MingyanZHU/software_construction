...
public interface Graph<L, E> {
  ...
  /**
   * Remove a vertex from Graph, and any edges connected it will be also removed. If it belongs to
   * the hyper edge and hyper edge consisted of less than two vertices, the hyper edge will also
   * removed; otherwise the hyper edge will not be removed.
   *
