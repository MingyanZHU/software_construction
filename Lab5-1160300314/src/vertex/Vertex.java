...
public abstract class Vertex implements Cloneable {
  ...
  Safety for Rep Exposure:
      The label filed is modified by private and final.
      Clients can not access it outside this class.
   */
   ...
   * @throws InputFileAgainException if there are some errors occur which need to choose another
   *          input file.
   */
