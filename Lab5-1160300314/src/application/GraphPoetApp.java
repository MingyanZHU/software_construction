...
public class GraphPoetApp {
   ...
   */
  public GraphPoetApp() {
    String filePath = "src/txt/Spring2018_HITCS_SC_Lab5/file4.txt";
  ...
  /**
   * for GraphPoetApp running.
   */
  public static void main(String[] args) throws IOException {
    long startTime = System.currentTimeMillis();
    long endTime;
    final GraphPoetApp graphPoetApp = new GraphPoetApp();
    //    graphPoetApp.visible();
    endTime = System.currentTimeMillis();
    System.err.println(endTime - startTime);
    startTime = System.currentTimeMillis();
    OutputGraph.outputGraph(graphPoetApp.graph, "src/txt/outputgraph.txt");
    endTime = System.currentTimeMillis();
    System.err.println(endTime - startTime);
  }
}
